...
export function createMode(mode: VisualMode, scene: THREE.Scene): IVisualMode {
  switch (mode) {
    ...
    case 'plasma-flow':     return new PlasmaFlow(scene)
    ...
    case 'kaleidoscope':    return new Kaleidoscope(scene)
  }
}
